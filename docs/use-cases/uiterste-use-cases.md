...
## Politieke groepering doet mee aan verkiezingen ️️(wolk)
...
7. Politieke groepering ontvangt geen verzuimbrief binnen de deadline.
8. Politieke groepering stelt vast dat de volledige kandidatenlijst op het Proces Verbaal (welk?) staan.
9. Politieke groepering verschijnt op het stembiljet.

__Uitbreidingen__:

5a. Politieke groepering ontvangt bericht met te maken wijzigingen van Centraal Stembureau:  
...
7a. Politieke groepering ontvangt verzuimbrief:  
&emsp; 7a1. Politieke groepering herstelt verzuimen.  
&emsp; 7a2. Politieke groepering dient de set van documenten opnieuw in.

8a. Politieke groepering stelt vast dat kandidaten of lijsten geschrapt zijn:  
&emsp; 8a1. Politieke groepering besluit niet in beroep te gaan.  
&emsp; &emsp; 8a1a. Politieke groepering besluit in beroep te gaan:  
&emsp; 8a2. Politieke groepering verschijnt gedeeltelijk of niet op het stembiljet.
   		

### Open punten

- Ontvangt een politieke groepering die geen verzuimen heeft een bevestiging o.i.d.?
...
## Ontvangers verkiezingsdefinitie zetten het proces verder

## De wereld wordt geïnformeerd
